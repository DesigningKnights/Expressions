...
public class TestEvalsJava {
    ...
    public void testSqrt() {
        ...
        assertEquals("1.4142136", new Expression("SQRT(2)").eval().toPlainString());
        assertEquals("1.41421356237309504880168872420969807856967187537694807317667973799073247846210703885038753432764157273501384623091229702492483606", new Expression("SQRT(2)").setPrecision(128).eval().toPlainString());
        assertEquals("2.236068", new Expression("SQRT(5)").eval().toPlainString());
        assertEquals("99.3730346", new Expression("SQRT(9875)").eval().toPlainString());
        assertEquals("2.3558438", new Expression("SQRT(5.55)").eval().toPlainString());
    ...
    public void testRounding() {
        ...
        assertEquals("3.735", new Expression("round(3.7345,3)").eval().toPlainString());
        assertEquals("-3.735", new Expression("round(-3.7345,3)").eval().toPlainString());
